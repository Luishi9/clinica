    ...
    <script type="text/javascript">
        ...
        if (acceptButton) {
            ...
            acceptButton.addEventListener("click", () => {
                ...
                let d = new Date();
                // Incrementar el tiempo actual en 1 minuto (la cookie expirará después de 1 minuto)
                d.setMinutes(2 + d.getMinutes());
                // Crear una cookie con nombre = myCookieName, valor = thisIsMyCookie y tiempo de expiración = 1 minuto
